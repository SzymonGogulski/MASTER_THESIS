...
Generator})~\cite{2025QRNG-zeshan}.Podklasą generatorów pseudolosowych są generatory pseudolosowe kryptograficznie 
...
Komercyjnie dostępny jest kwantowy generator Quantis-USB-4M firmy IDQ. 
...
\noindent Wektor bitów pozyskiwany bezpośrednio ze źródła analogowego charakteryzuje się 
...
źródła oraz sprawdzeniu zestawu trzech instrukcji~\cite{ch2-randomness-extractor-von-neumann}:
...
każdego z bitów, ale znacznie ogranicza wydajność generatora. Jednocześnie 
...
bit ma wpływ jednocześnie na wszystkie bity wyjściowe~\cite{neoTRNG}. W ten sposób eliminuje 
...
bitów ziarna~\cite{ch2-Toeplitz}.
...
wygenerować spore ilości danych losowych dla kolejnych wartości z licznika 
...
na początku procesu~\cite{NIST-IR-6390}.  
