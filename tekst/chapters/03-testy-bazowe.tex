...
\noindent Testy przeprowadzono na zmodyfikowanej module neoTRNG. Moduł został rozszerzony 
o dwa parametry generyczne \textit{ENABLE\_VON\_NEUMANN} oraz \textit{ENABLE\_CRC}. Zmodyfikowany 
plik znajduje się w załączniku A neoTRNG\_mod\_1.vhd.

Każdy z przypadków został uruchomiony na sprzęcie, wyniki zostały zapisane do plików:
