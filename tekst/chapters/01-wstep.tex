...
Osobna faza badań poruszy kwestie analizy odporności układu oraz mechanizmów monitorowania. 
Zbadany zostanie wpływ modułów testowych (Health Tests) oraz wpływ warunków 
