...
\textbf{Pytania}
\begin{enumerate}
    \item Jak dodać informację o licencji neoTRNG?
    \item czy można cytować repozytorium github?
    \item czy dodać spis fragmentów kodu tak jak spis rysunków/tabel?
    \item Jak powiedzieć de-biasing/ sampling po polsku?
    \item Ile MiB danych do wykonania testów? (zbierałem 10MiB)
    \item NIST SP 800-90B używać testów IID czy non-IID?
    \item kto jest autorem neoTRNG
    \item publikajce naukowe do uwzględnienia w pracy - sugestie lub wymagania 
\end{enumerate}
