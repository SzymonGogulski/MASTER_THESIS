...
%---------------------------------------------------------
\begin{frame}
\frametitle{Wprowadzenie: Rola OSHWA}

\LARGE

Rola OSHWA w Bezpieczeństwie Systemów Brzegowych

\begin{itemize}
\item odpowiedź na kryzys zaufania do technologii zamkniętoźródłowych,
\item weryfikowalność i transparentność dostępnych rozwiązań,
\item rozpowszechnianie gotowych rozwiązań.
\end{itemize}

\end{frame}
%---------------------------------------------------------
\begin{frame}
\frametitle{Znaczenie dla Systemów Brzegowych}

\LARGE



Jest to szczególnie ważne dla systemów brzegowych, które wymagają 
sprawdzonych i bezpiecznych modułów kryptograficznych.
...
%---------------------------------------------------------
\begin{frame}
\frametitle{Aspekty generatora objęte modyfikacjami}
...
%---------------------------------------------------------
\begin{frame}
\frametitle{Przykładowe wyniki}

    \begin{figure}[H]
      \includegraphics[width=\textwidth]{figures/wynik.png}
      \caption{Przykładowy wynik testu NIST SP 800-22}
    \end{figure}
...
\frametitle{Przykładowe wyniki}
    ...
    \begin{figure}[H]
      \includegraphics[width=\textwidth]{figures/wyniki2.png}
      \caption{Przykładowy wynik testu NIST SP 800-22}
    \end{figure}
